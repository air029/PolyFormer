...
def hetergraph_fixed_split(dataset, data, idx_run):
    data.train_mask = dataset[0].train_mask[idx_run]
    data.val_mask = dataset[0].val_mask[idx_run]
    data.test_mask = dataset[0].test_mask[idx_run]
    print(data.test_mask.shape)
    return data
